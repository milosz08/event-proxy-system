package pl.miloszgilga.event.proxy.server.parser.message;

import pl.miloszgilga.event.proxy.server.AppConfig;
import pl.miloszgilga.event.proxy.server.parser.AbstractEmailParser;
...
public class DvrEmailParser extends AbstractEmailParser {
  ...
  public DvrEmailParser(AppConfig appConfig) {
    super(appConfig);
  }
